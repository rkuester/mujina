...
define_pmbus_commands! {
    ...
    IoutCalGain = 0x38, "IOUT_CAL_GAIN", "output current calibration gain",
    IoutCalOffset = 0x39, "IOUT_CAL_OFFSET", "output current calibration offset",
    VoutOvFaultLimit = 0x40, "VOUT_OV_FAULT_LIMIT", "output overvoltage fault limit",
    VoutOvFaultResponse = 0x41, "VOUT_OV_FAULT_RESPONSE", "output overvoltage fault response",
    ...
    VoutUvFaultResponse = 0x45, "VOUT_UV_FAULT_RESPONSE", "output undervoltage fault response",
    ...
    // TPS546-specific commands
    PowerStageConfig = 0xB5, "POWER_STAGE_CONFIG", "power stage configuration",
    TelemetryConfig = 0xD0, "TELEMETRY_CONFIG", "telemetry configuration",
